                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10">
                            ...
                            <p class="text-base font-bold leading-normal text-white-dark">Ingrese sus credenciales para acceder al sistema</p>
                        </div>
                        <!-- Mensaje de error -->
                        ...
                        <form class="space-y-5 dark:text-white" @submit.prevent="handleLogin">
                            ...
                            <div>
                                <label class="flex cursor-pointer items-center">
                                    <input v-model="form.remember" type="checkbox" class="form-checkbox bg-white dark:bg-black" />
                                    <span class="text-white-dark">Recordar mi sesión</span>
                                </label>
                            </div>
                            <button
                                type="submit"
                                :disabled="loading || !form.email || !form.password"
                                class="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)] disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                <span v-if="loading" class="animate-spin inline-block w-4 h-4 border-[2px] border-current border-t-transparent rounded-full mr-2"></span>
        ...
        try {
            ...
            if (result.success) {
                ...
                if ((result as any).message) {
                    errorMessage.value = (result as any).message;
                } else if (errors?.auth) {
                    errorMessage.value = errors.auth[0];
