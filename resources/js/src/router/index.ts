...
const routes: RouteRecordRaw[] = [
    // authentication (con prefijo administrador)
    {
        ...
        name: 'boxed-signin',
        component: () => import(/* webpackChunkName: "auth-boxed-signin" */ '../views/auth/login.vue'),
        meta: { layout: 'auth' },
    },
    {
    ...
    // Redirección de la raíz
    {
        ...
        redirect: () => {
            ...
            return authStore.isAuthenticated ? '/administrador/home' : '/administrador/login';
        }
    },
...
router.beforeEach(async (to, from, next) => {
    ...
    const publicRoutes = ['/administrador/login', '/administrador/auth/boxed-signup', '/administrador/auth/boxed-lockscreen', '/administrador/auth/cover-password-reset', '/administrador/auth/cover-signup'];
