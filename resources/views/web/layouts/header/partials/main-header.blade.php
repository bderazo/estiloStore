        ...
        <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
            ...
            <div class="main__logo">
                <h1 class="main__logo--title"><a class="main__logo--link" href="{{ url('/') }}"><img
                            class="main__logo--img" src="{{ asset('web/assets/imagenes/nav-log.png') }}"
                            alt="logo-img"></a>
                </h1>
            </div>
            <div class="header__search--widget header__sticky--none d-none d-lg-block">
                <form class="d-flex header__search--form" action="{{ route('web.buscar') }}" method="GET">
                    <div class="header__select--categories select">
                        <select class="header__select--inner" name="c">
                    ...
                    <div class="header__search--box">
                        <input class="header__search--input" name="q" placeholder="Buscar productos..." type="text">
                    ...
                    @auth
                        <li class="header__account--items">
                            <a class="header__account--btn" href="{{ route('web.pedidos.index') }}">
                                ...
                                <span class="header__account--btn__text">Mis Pedidos</span>
                            </a>
                        </li>
                    @endauth
                    ...
                    @if (isset($folletoPrincipal))
                        <li class="header__account--items">
                            <a class="header__account--btn" href="{{ route('folleto.descargar', $folletoPrincipal->id) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                                ...
                                                @foreach ($padre->children as $hijo)
                                                    <li class="header__mega--sub__menu_li">
                                                        <a class="header__mega--sub__menu--title"
                                                            href="{{ route('tienda.categoria', $hijo->slug) }}">
                                                            {{ $hijo->nombre }}
                                                        </a>
                                                    </li>
                                                @endforeach
                                ...
                                <li class="header__mega--menu__li">
                                    ...
                                    <ul class="header__mega--sub__menu">
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="shop.html">Tienda con barra lateral izquierda</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="shop-right-sidebar.html">Tienda con barra lateral derecha</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="shop-grid.html">Tienda en cuadrícula</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="shop-grid-list.html">Tienda lista y cuadrícula</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="shop-list.html">Tienda en lista</a></li>
                                    </ul>
                                </li>
                                <li class="header__mega--menu__li">
                                    ...
                                    <ul class="header__mega--sub__menu">
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="product-details.html">Detalles del producto</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="product-video.html">Producto con vídeo</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="product-details.html">Producto variable</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="product-left-sidebar.html">Producto con barra lateral
                                                izquierda</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="product-gallery.html">Galería de productos</a></li>
                                    </ul>
                                </li>
                                <li class="header__mega--menu__li">
                                    ...
                                    <ul class="header__mega--sub__menu">
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="my-account.html">Mi cuenta</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="my-account-2.html">Mi cuenta 2</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="404.html">Página 404</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="login.html">Página de inicio de sesión</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="faq.html">Página de preguntas frecuentes</a></li>
                                    </ul>
                                </li>
                                <li class="header__mega--menu__li">
                                    ...
                                    <ul class="header__mega--sub__menu">
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="compare.html">Páginas de comparación</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="checkout.html">Página de pago</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="checkout-2.html">Pago estilo 2</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="checkout-3.html">Pago estilo 3</a></li>
                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title"
                                                href="checkout-4.html">Pago estilo 4</a></li>
                                    </ul>
                                </li>
                            </ul> --}}
                        </li>
                            ...
                            <a class="header__account--btn" href="{{ route('web.pedidos.index') }}" title="Mis Pedidos">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443" viewBox="0 0 512 512">
                                    ...
                                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="32" d="M75 160l181 104 181-104M256 264v200" />
                                </svg>
