                ...
                <div class="shipping__style3--inner border-radius-10 d-flex justify-content-between">
                    <div class="shipping__style3--items d-flex align-items-center">
                        ...
                        <div class="shipping__style3--content">
                          <h2 class="shipping__style3--content__title">Regístrate</h2>
                          <p class="shipping__style3--content__desc">Para que una Gerente de Zona te llame, dé todos los detalles y despeje tus dudas.</p>
                        </div>
                    </div>
                    <div class="shipping__style3--items d-flex align-items-center">
                        <div class="shipping__style3--icon">
                        ...
                        <div class="shipping__style3--content">
                          <h2 class="shipping__style3--content__title">Agenda tu pedido</h2>
                          <p class="shipping__style3--content__desc">Recibe tu número de Dama y PIN para ingresar el primero de muchos pedidos.</p>
                        </div>
                    </div>
                    <div class="shipping__style3--items d-flex align-items-center">
                        <div class="shipping__style3--icon">
                        ...
                        <div class="shipping__style3--content">
                          <h2 class="shipping__style3--content__title">Recibe tu pedido</h2>
                          <p class="shipping__style3--content__desc">Lo entregamos directo en la puerta de tu hogar.</p>
                        </div>
                    </div>
