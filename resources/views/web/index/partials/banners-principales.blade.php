            ...
            <div class="col-lg-5 col-md-order mb-28">
                <div class="banner__items">
                    <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                            class="banner__items--thumbnail__img" src="{{asset('web/assets/img/banner/banner1.png')}}"
                            alt="banner-img">
            ...
            <div class="col-lg-7 mb-28">
                <div class="row row-cols-lg-2 row-cols-sm-2 row-cols-1">
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                    class="banner__items--thumbnail__img" src="{{asset('web/assets/img/banner/banner2.png')}}"
                                    alt="banner-img">
                                <div class="banner__items--content">
                    ...
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                    class="banner__items--thumbnail__img" src="{{asset('web/assets/img/banner/banner3.png')}}"
                                    alt="banner-img">
                                <div class="banner__items--content">
                ...
                <div class="banner__items">
                    <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                            ...
                            src="{{asset('web/assets/img/banner/banner4.png')}}" alt="banner-img">
                        <div class="banner__items--content">
