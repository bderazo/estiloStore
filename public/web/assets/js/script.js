...
// slider swiper activation con mejoras de accesibilidad
const heroSliderElement = document.querySelector(".hero__slider--activation");
if (heroSliderElement) {
  const updateHeroAria = (instance) => {
    const slides = heroSliderElement.querySelectorAll(".swiper-slide");
    slides.forEach((slide, index) => {
      const isActive = index === instance.realIndex;
  ...
  const heroSwiper = new Swiper(heroSliderElement, {
    slidesPerView: 1,
    loop: true,
    clickable: true,
    speed: 800,
  ...
  heroSliderElement.setAttribute("data-swiper-instance", "hero");
}
